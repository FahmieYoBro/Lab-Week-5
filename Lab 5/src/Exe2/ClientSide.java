...
public class ClientSide {
	...
	public static void main(String[] args) {
		...
		// Request data
		ItemProduct location = new ItemProduct();
		...
		try {
			...
			location = (ItemProduct) objectIS.readObject();
			System.out.println ("Id for " + location.getName() + " is " + location.getItemProductId());
